...
<div class="position-relative overflow-hidden bg-dark text-white py-5" style="background: linear-gradient(rgba(10, 15, 20, 0.8), rgba(10, 15, 20, 0.9)), url('https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=2073&auto=format&fit=crop') center center / cover no-repeat; padding-top: 100px !important; padding-bottom: 100px !important;">
    ...
    <div class="position-absolute bottom-0 start-0 w-100 bg-light" style="height: 30px; clip-path: polygon(0 100%, 100% 100%, 100% 0);"></div>
</div>

<div class="bg-light" id="timeline-start">
    <div class="container py-5">
        
        <div class="text-center mb-5 pb-4 reveal-item">
            <h2 class="display-5 fw-bold text-dark">7 Steps to Property Ownership</h2>
            <p class="text-muted fs-5">Standard Operating Procedures (SOP) compliant with the Housing Development Act (HDA) Malaysia.</p>
        ...
        <div class="timeline-wrapper position-relative">
            <div class="timeline-spine d-none d-lg-block"></div>
            ...
            <div class="row align-items-center mb-5 pb-5 timeline-item reveal-item">
                <div class="col-lg-5 order-2 order-lg-1 text-lg-end text-center pe-lg-5">
                    <div class="badge bg-dark text-white px-3 py-2 rounded-pill mb-3 fs-6 shadow-sm">STEP 01</div>
                    <h3 class="fw-bold text-primary mb-3">Financial Health & DSR Check</h3>
                    <p class="text-muted lh-lg">Before hunting for properties, you must establish a concrete budget. Banks evaluate your borrowing capacity using the <strong>Debt Service Ratio (DSR)</strong> and your central credit scores (CCRIS/CTOS). Aim to keep your DSR below 60%.</p>
                    
                    <div class="p-3 bg-white border border-primary border-opacity-25 rounded-3 text-start d-inline-block shadow-sm mb-3 text-lg-end w-100">
                        <h6 class="fw-bold text-dark mb-2"><i class="fas fa-building text-warning me-2"></i> Government & Authorities Involved:</h6>
                        <ul class="list-unstyled m-0 small text-muted font-monospace">
                            <li class="mb-1"><strong class="text-dark">BNM (Bank Negara Malaysia):</strong> Generates CCRIS report.</li>
                            <li class="mb-1"><strong class="text-dark">KWSP (EPF):</strong> Allows Account 2 withdrawal for house purchasing.</li>
                        </ul>
                    </div>
                    
                    <div class="alert alert-warning border-0 shadow-sm text-start small fw-bold">
                        <i class="fas fa-lightbulb text-warning me-2"></i> Pro Tip: Utilize our <a href="financial_planner.php" class="text-dark text-decoration-underline">SYS Financial Planner</a> to simulate your DSR before approaching banks.
                    </div>
                </div>
                <div class="col-lg-2 order-1 order-lg-2 d-none d-lg-flex justify-content-center z-3">
                    <div class="timeline-dot bg-primary border border-4 border-white shadow"></div>
                </div>
                <div class="col-lg-5 order-3 order-lg-3 ps-lg-5 mb-4 mb-lg-0 text-center">
                    <div class="img-wrapper rounded-4 shadow-lg overflow-hidden position-relative border border-5 border-white">
            ...
            <div class="row align-items-center mb-5 pb-5 timeline-item reveal-item">
                ...
                <div class="col-lg-2 order-2 order-lg-2 d-none d-lg-flex justify-content-center z-3">
                    <div class="timeline-dot bg-info border border-4 border-white shadow"></div>
                </div>
                <div class="col-lg-5 order-1 order-lg-3 text-lg-start text-center ps-lg-5">
                    <div class="badge bg-dark text-white px-3 py-2 rounded-pill mb-3 fs-6 shadow-sm">STEP 02</div>
                    <h3 class="fw-bold text-info mb-3">Booking & Letter of Offer (OTP)</h3>
                    <p class="text-muted lh-lg">Once you've surveyed and selected your ideal property through our offline showroom, you will sign an <strong>Offer to Purchase (OTP)</strong> form. You must pay an earnest booking fee, usually <strong>2% to 3%</strong> of the property price, which forms part of your total 10% downpayment.</p>
                    
                    <div class="p-3 bg-white border border-info border-opacity-25 rounded-3 text-start d-inline-block shadow-sm mb-3 w-100">
                        <h6 class="fw-bold text-dark mb-2"><i class="fas fa-building text-warning me-2"></i> Regulatory Framework:</h6>
                        <ul class="list-unstyled m-0 small text-muted font-monospace">
                            <li class="mb-1"><strong class="text-dark">KPKT (Ministry of Housing):</strong> Governs developer licensing. Ensure you only pay booking fees to licensed developers or registered agency accounts, never personal accounts.</li>
                        </ul>
                    </div>

                    <div class="alert alert-danger border-0 shadow-sm text-start small fw-bold">
            ...
            <div class="row align-items-center mb-5 pb-5 timeline-item reveal-item">
                <div class="col-lg-5 order-2 order-lg-1 text-lg-end text-center pe-lg-5">
                    <div class="badge bg-dark text-white px-3 py-2 rounded-pill mb-3 fs-6 shadow-sm">STEP 03</div>
                    <h3 class="fw-bold text-success mb-3">Applying for the Mortgage</h3>
                    <p class="text-muted lh-lg">With your OTP secured, you generally have 14 to 21 days to secure a housing loan. You will submit your 3-6 months payslips, EPF statements, and EA forms to multiple banks. Upon approval, you will sign the <strong>Bank Letter of Offer (LO)</strong>, locking in your Interest Rate (BR/OPR) and Margin of Finance (up to 90%).</p>
                    
                    <div class="p-3 bg-white border border-success border-opacity-25 rounded-3 text-start d-inline-block shadow-sm mb-3 text-lg-end w-100">
                        <h6 class="fw-bold text-dark mb-2"><i class="fas fa-building text-warning me-2"></i> Associated Entities:</h6>
                        <ul class="list-unstyled m-0 small text-muted font-monospace">
                            <li class="mb-1"><strong class="text-dark">Commercial Banks:</strong> Maybank, CIMB, Public Bank, etc.</li>
                            <li class="mb-1"><strong class="text-dark">Valuers (JPPH):</strong> For subsale, banks appoint valuers to assess the true brick-and-mortar market value.</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-2 order-1 order-lg-2 d-none d-lg-flex justify-content-center z-3">
                    <div class="timeline-dot bg-success border border-4 border-white shadow"></div>
                </div>
                <div class="col-lg-5 order-3 order-lg-3 ps-lg-5 mb-4 mb-lg-0 text-center">
                    <div class="img-wrapper rounded-4 shadow-lg overflow-hidden position-relative border border-5 border-white">
            ...
            <div class="row align-items-center mb-5 pb-5 timeline-item reveal-item">
                ...
                <div class="col-lg-2 order-2 order-lg-2 d-none d-lg-flex justify-content-center z-3">
                    <div class="timeline-dot bg-danger border border-4 border-white shadow"></div>
                </div>
                <div class="col-lg-5 order-1 order-lg-3 text-lg-start text-center ps-lg-5">
                    <div class="badge bg-dark text-white px-3 py-2 rounded-pill mb-3 fs-6 shadow-sm">STEP 04</div>
                    <h3 class="fw-bold text-danger mb-3">Executing the S&P Agreement (SPA)</h3>
                    <p class="text-muted lh-lg">Now you officially hire a conveyancing lawyer to draft the <strong>Sales & Purchase Agreement (SPA)</strong>. Upon signing, you must settle the remaining balance of your 10% downpayment (e.g., if booking was 2%, you pay the remaining 8%). You will also pay the Lawyer's Professional Legal Fees at this stage.</p>
                    
                    <div class="p-3 bg-white border border-danger border-opacity-25 rounded-3 text-start d-inline-block shadow-sm w-100">
                        <h6 class="fw-bold text-dark mb-2"><i class="fas fa-gavel text-warning me-2"></i> Legal Framework:</h6>
                        <ul class="list-unstyled m-0 small text-muted font-monospace">
                            <li class="mb-1"><strong class="text-dark">HDA Schedule H/G:</strong> For under-construction projects, the SPA format is strictly protected under the Housing Development (Control and Licensing) Act 1966.</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center mb-5 pb-5 timeline-item reveal-item">
                <div class="col-lg-5 order-2 order-lg-1 text-lg-end text-center pe-lg-5">
                    <div class="badge bg-dark text-white px-3 py-2 rounded-pill mb-3 fs-6 shadow-sm">STEP 05</div>
                    <h3 class="fw-bold text-warning mb-3">MOT & Stamp Duty Stamping</h3>
                    <p class="text-muted lh-lg">Your lawyer submits the <strong>Memorandum of Transfer (MOT)</strong> and Loan Agreement to the government for stamping. This is where you pay the heaviest hidden cost: The Stamp Duty. For under-construction properties, MOT stamping happens later when the strata/individual title is issued.</p>
                    
                    <div class="p-3 bg-white border border-warning border-opacity-50 rounded-3 text-start d-inline-block shadow-sm mb-3 text-lg-end w-100">
                        <h6 class="fw-bold text-dark mb-2"><i class="fas fa-landmark text-warning me-2"></i> Key Government Departments:</h6>
                        <ul class="list-unstyled m-0 small text-muted font-monospace">
                            <li class="mb-1"><strong class="text-dark">LHDN (Inland Revenue Board):</strong> Assesses and collects the Ad Valorem Stamp Duty.</li>
                            <li class="mb-1"><strong class="text-dark">PTG (Pejabat Tanah & Galian):</strong> The State Land Office registers your name into the property title.</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-2 order-1 order-lg-2 d-none d-lg-flex justify-content-center z-3">
                    <div class="timeline-dot bg-warning border border-4 border-white shadow"></div>
                </div>
                <div class="col-lg-5 order-3 order-lg-3 ps-lg-5 mb-4 mb-lg-0 text-center">
                    <div class="img-wrapper rounded-4 shadow-lg overflow-hidden position-relative border border-5 border-white">
            ...
            <div class="row align-items-center mb-5 pb-5 timeline-item reveal-item">
                <div class="col-lg-5 order-3 order-lg-1 pe-lg-5 mb-4 mb-lg-0 text-center">
                    <div class="img-wrapper rounded-4 shadow-lg overflow-hidden position-relative border border-5 border-white">
                        <img src="https://images.unsplash.com/photo-1541888081622-1d575c324c48?q=80&w=2070&auto=format&fit=crop" class="img-fluid w-100" alt="Construction Site" style="height: 350px; object-fit: cover;">
                        <div class="position-absolute bottom-0 start-0 w-100 p-3 bg-dark bg-opacity-75 text-white text-start">
                ...
                <div class="col-lg-2 order-2 order-lg-2 d-none d-lg-flex justify-content-center z-3">
                    <div class="timeline-dot bg-secondary border border-4 border-white shadow"></div>
                </div>
                <div class="col-lg-5 order-1 order-lg-3 text-lg-start text-center ps-lg-5">
                    <div class="badge bg-dark text-white px-3 py-2 rounded-pill mb-3 fs-6 shadow-sm">STEP 06</div>
                    <h3 class="fw-bold text-secondary mb-3">Progressive Loan Disbursement</h3>
                    <p class="text-muted lh-lg">You do NOT pay the full monthly installment immediately for new projects. The bank releases money to the developer in stages as construction completes (Progressive Billing). During this period of 2 to 4 years, you only pay <strong>Progressive Interest</strong> to the bank based on the amount disbursed.</p>
                    
                    <div class="p-3 bg-white border border-secondary border-opacity-25 rounded-3 text-start d-inline-block shadow-sm w-100">
                        <h6 class="fw-bold text-dark mb-2"><i class="fas fa-hard-hat text-warning me-2"></i> Construction Protection:</h6>
                        <ul class="list-unstyled m-0 small text-muted font-monospace">
            ...
            <div class="row align-items-center mb-5 pb-5 timeline-item reveal-item">
                <div class="col-lg-5 order-2 order-lg-1 text-lg-end text-center pe-lg-5">
                    <div class="badge bg-dark text-white px-3 py-2 rounded-pill mb-3 fs-6 shadow-sm">FINAL STEP</div>
                    <h3 class="fw-bold text-dark mb-3">Keys Collection & Vacant Possession (VP)</h3>
                    <p class="text-muted lh-lg">Once the property obtains the CCC (Certificate of Completion and Compliance), the developer will issue the Notice of Vacant Possession. You finally collect your keys! Upon receiving keys, a 24-month <strong>Defect Liability Period (DLP)</strong> acts as your warranty to claim free repairs for any structural defects.</p>
                    ...
                    <div class="p-3 bg-success bg-opacity-10 border border-success border-opacity-50 rounded-3 text-start d-inline-block shadow-sm text-lg-end w-100">
                        ...
                        <ul class="list-unstyled m-0 small text-dark font-monospace">
...
<div class="container my-5 py-5 reveal-item">
    <div class="row g-5">
        <div class="col-lg-6">
            <h3 class="fw-bold text-dark mb-4 border-bottom border-primary border-3 pb-3"><i class="fas fa-book text-primary me-2"></i> Essential Real Estate Glossary</h3>
            <div class="accordion shadow-sm border-0 rounded-4 overflow-hidden" id="glossaryAccordion">
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button fw-bold bg-white" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button fw-bold bg-white collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                ...
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header">
                        <button class="accordion-button fw-bold bg-white collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree">
                ...
                <div class="accordion-item border-0">
                    <h2 class="accordion-header">
                        <button class="accordion-button fw-bold bg-white collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour">
        ...
        <div class="col-lg-6">
            <h3 class="fw-bold text-dark mb-4 border-bottom border-warning border-3 pb-3"><i class="fas fa-landmark text-warning me-2"></i> Regulatory Agencies Matrix</h3>
            <div class="row g-3">
                <div class="col-sm-6">
                    <div class="p-3 border rounded-3 bg-white h-100 hover-border-shift">
                        <h6 class="fw-bold text-dark m-0 mb-1">BNM</h6>
                        <small class="text-muted d-block mb-2" style="font-size: 0.75rem;">Bank Negara Malaysia</small>
                        <p class="small text-secondary m-0">Regulates banking systems, oversees OPR, and maintains the CCRIS central credit database.</p>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="p-3 border rounded-3 bg-white h-100 hover-border-shift">
                        <h6 class="fw-bold text-dark m-0 mb-1">LHDN</h6>
                        <small class="text-muted d-block mb-2" style="font-size: 0.75rem;">Lembaga Hasil Dalam Negeri</small>
                        <p class="small text-secondary m-0">Validates legal documents and collects Ad Valorem Stamp Duty for property transfers.</p>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="p-3 border rounded-3 bg-white h-100 hover-border-shift">
                        <h6 class="fw-bold text-dark m-0 mb-1">PTG</h6>
                        <small class="text-muted d-block mb-2" style="font-size: 0.75rem;">Pejabat Tanah & Galian</small>
                        <p class="small text-secondary m-0">The state land authority responsible for updating title deeds and recording ownership.</p>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="p-3 border rounded-3 bg-white h-100 hover-border-shift">
                        <h6 class="fw-bold text-dark m-0 mb-1">KPKT</h6>
                        <small class="text-muted d-block mb-2" style="font-size: 0.75rem;">Ministry of Housing</small>
                        <p class="small text-secondary m-0">Enforces the Housing Development Act (HDA) protecting buyers from abandoned projects.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container mb-5 pb-5">
    <div class="bg-dark text-white rounded-4 p-5 text-center shadow-lg position-relative overflow-hidden">
        <div class="position-absolute top-0 start-0 w-100 h-100 opacity-25" style="background: repeating-linear-gradient(45deg, transparent, transparent 10px, #333 10px, #333 20px);"></div>
        <div class="position-relative z-3">
            <h2 class="fw-bold mb-3">Ready to Embark on Your Journey?</h2>
...
<style>
    ...
    .timeline-spine { position: absolute; left: 50%; top: 0; bottom: 0; width: 4px; background: #e9ecef; transform: translateX(-50%); z-index: 1; }
    ...
    .hover-border-shift:hover { border-left: 4px solid #0d6efd !important; box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important; transform: translateY(-3px); }
