...
function is_valid_mobile($phone_number) {
    return preg_match('/^\d{10,11}$/', $phone_number) === 1;
}
...
function create_pending_registration_otp($conn, $post_data, &$error_message, &$show_duplicate_alert, &$duplicate_email, &$otp_message, &$show_otp_modal) {
    ...
    if (!is_valid_mobile($phone_number)) {
        $error_message = 'Phone number must be a valid mobile number with 10 or 11 digits.';
        return;
    }
            ...
            <div class="card shadow-sm border-0 auth-card">
                <div class="card-body p-5">
                    <div class="text-center mb-5">
                        <img loading="lazy" src="SYS%20Property%20Catalog/SYS_Property_Holdings_Icon.jpeg" alt="SYS Property Logo" style="height: 60px; width: auto; border-radius: 8px; object-fit: contain;" class="mb-3 shadow-sm">
                    ...
                    <form method="POST" action="register.php">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="tel" name="phone_number" class="form-control py-2" value="<?php echo isset($form_values['phone_number']) ? htmlspecialchars($form_values['phone_number']) : ''; ?>" inputmode="numeric" minlength="10" maxlength="11" title="Enter a valid mobile number with 10 or 11 digits. Example: 1234567890" required>
                                <small class="text-muted d-block mt-1">EXAMPLE: (0123456789/01234567890)</small>
                            </div>
                            <div class="col-md-6">
